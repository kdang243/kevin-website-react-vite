...
const GitHubButton = ( {link}) => {
  ...
  return (
    <>
      <a className="inline-flex ml-4 mt-3 mb-3 rounded-md border-2 border-white text-white cursor-pointer" href={link} target="_blank" rel="noreferrer">
            ...
            <span className="font-bold text-lg  ml-1 mr-1.5">GitHub {'>'}</span>
        </a>
    </>
  )
}
