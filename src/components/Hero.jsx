const Hero = () => {
  return (
    <>
    <div className="bg-vanilla min-h-screen flex items-center justify-center px-16">
        <div className="relative w-full h-full max-w-xl">        
            ...
            <div className="bottom-24 relative w-full space-y-4 font-sans font-semibold text-white items text-center justify-center ">
